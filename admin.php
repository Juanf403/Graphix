	...
	<section class="vbox">
		<header class="bg-black dk header navbar navbar-fixed-top-xs">
			...
			<ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="http://flatfull.com/themes/note/images/avatar_default.jpg"> </span>Graphix<b class="caret"></b> </a>
